      ...
      <main className="pt-14">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-muted-foreground">
            <p>
              By accessing and using Aniflix, you accept and agree to be bound
            ...
            <p>
              The materials on Aniflix are provided on an &apos;as is&apos;
              basis. Aniflix makes no warranties, expressed or implied, and
            ...
            <p>
              Aniflix does not host any video content. All videos are hosted by
            ...
            <p>
              In no event shall Aniflix or its suppliers be liable for any
            ...
            <p>
              Aniflix may revise these terms of service at any time without
